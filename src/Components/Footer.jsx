        ...
        <div className="py-8 md:py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              <a href="/" className="text-2xl font-bold text-gray-900 font-allura">
               Mihir Shiroya
              </a>
            ...
            <div className='w-full flex flex-row justify-around'>
              <div>
                ...
                <ul className="mt-4 space-y-2">
                  {['Home', 'About', 'Projects', 'Contact'].map((item) => (
                    <li key={item}>
                      <a href={`/${item.toLowerCase()}`} className="text-base text-gray-600 hover:text-gray-900">
                        {item}
                      </a>
                    </li>
                  ))}
              ...
              <div>
                ...
                <ul className="mt-4 space-y-2">
                  ...
                  <li>
                    <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-600 hover:text-gray-900">
